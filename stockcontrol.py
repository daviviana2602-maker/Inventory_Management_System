    ...
    while True:
        ...
        with Session() as session:  # create session
            ...
            if not sales:
                ...
                print(f'{Back.GREEN}Lucro das vendas nesse período: R${total_profit:.2f}{Style.RESET_ALL}')
                print(f'{Back.RED}Perda total com produtos retirados nesse período: R${total_prejudice_value:.2f}{Style.RESET_ALL}')
                print(f'{Back.GREEN}Lucro total real nesse período: R${total_real_profit:.2f}{Style.RESET_ALL}')
